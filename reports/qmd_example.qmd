...
![Horses](../results/horse_pops_plot.png){width=70% #fig-horse}
...
![Largest Std Dev in Horse Populations](../results/horse_pops_plot_largest_sd.png){width=70% #fig-horse_largest}

@fig-horse_largest: Horse populations for the province with the largest standard deviation

In @fig-horse_largest we zoom in and look at the province of ???, which had the largest spread of values in terms of standard deviation.
